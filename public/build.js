...
require.register("segmentio-hn-button-snippet/button.js", function(exports, require, module){
...
require.register("site/site.js", function(exports, require, module){
...
clip.on('complete', function (text) {
  var original = submit.innerText;
  submit.innerText = 'Copied!';
  animate(submit, 'tada', function () { submit.innerText = original; });
  window.analytics.track('Copied Code');
});
...
require.alias("ianstormtaylor-animate/index.js", "site/deps/animate/index.js");
...
require.alias("component-query/index.js", "segmentio-hn-button.js/deps/query/index.js");
